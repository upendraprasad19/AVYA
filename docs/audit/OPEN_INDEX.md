...
| OI-91 | 138 dead `CLAUDE.md §N` citations remain in live code/test/script comments… | nothing — mechanical, but large enough that it wants its own batch rather than | 2026-08-05 (count re-derived by grep at filing time; see the exact command below) | [:1664](open_issues.md#L1664) |
