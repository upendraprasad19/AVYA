...
| OI-105 | local `flutter test` runs ~3.9x slower per file than CI, cause unknown… | a contamination-free measurement on a quiet machine. Every candidate so far has | never — this is OI-102's unanswered half, carried forward unmeasured on 2026-08-11. | [:2497](open_issues.md#L2497) |
