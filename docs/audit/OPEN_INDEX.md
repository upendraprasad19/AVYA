...
| OI-88 | `restoring_screen.dart` split owed (allow-list entry now removed) (P3) | nobody yet — no session has picked up the split. The Gate 43 *exemption* half is | 2026-08-05 (`wc -l` = 791 on `repo-gate-pattern-sweep`; allow-list entry removed in | [:1543](open_issues.md#L1543) |
