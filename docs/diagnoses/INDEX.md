...
| 2026-09-22 | a4c7d1 | Founder-reported (2026-09-22, session "supabase-outage-check"): Single Leg Front Lever exercise swapped mid-active-workout from timed to weight/reps. Active workout screen showed "8 reps" (correct).… | logged_sets_format_normalization | test/contracts/logged_sets_format_normalization_behavioral_test.dart |
