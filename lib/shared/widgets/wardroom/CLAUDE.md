...
| WardTabHeader | ward_tab_header.dart | Unified 56dp top-row header for all 5 tab screens — `[avatar][TAB EYEBROW][spacer][streak chip][freeze chip]`. `docs/superpowers/specs/2026-04-28-apk-test-4-hotfix-batch-design.md` U7 (that doc's own section 3, "Unified tab headers"). |
| **Surface** | | |
