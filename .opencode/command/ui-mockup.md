---
description: "Visualise UI changes as a self-contained HTML mockup before writing any production code. Reads the **actual screen source first** to baseline accurately, then renders the proposed changes alongside in a side-by-side phon"
---
